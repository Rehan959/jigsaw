...
1. **Add Sources** — Enter URLs you want to crawl
2. **Crawl & Extract** — Playwright scrapes pages, extracts clean content
3. **Index & Embed** — Content is chunked, embedded via OpenAI, stored in Pinecone
4. **Search & Discover** — Semantic search across all sources with relevance scoring
...
│   ├── db/               # Drizzle schema (users, sources, crawlJobs)
